...
def sadtalker_demo(checkpoint_path='checkpoints', config_path='src/config', warpfn=None):
    ...
    optimum_max_threads = limit_max_threads * 0.5
                ...
                with gr.Tabs(elem_id="sadtalker_checkbox"):
                    with gr.TabItem('Settings'):
                        ...
                        with gr.Column(variant='panel'):
                            ...
                            with gr.Row():
                                max_threads = gr.Slider(label="Seamless Clone Max threads", step=1,
                                                        value=optimum_max_threads,
                                                        maximum=limit_max_threads,
                                                        minimum=1)

                            result_dir = gr.Textbox(label="Result dir", value="./results/")
